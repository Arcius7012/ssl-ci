...
Процедура СоздатьНовыйОбъект(ФайлРепозитория, Ветка) Экспорт
	...
	СправочникОбъект.Вид = ?(ЭтоОтчет, Перечисления.ВидыДополнительныхОтчетовИОбработок.ДополнительныйОтчет,
